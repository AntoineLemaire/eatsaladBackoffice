...
class City
{
     ...
     *      joinColumns={@ORM\JoinColumn(name="city_id", referencedColumnName="id", onDelete="CASCADE")},
     *      inverseJoinColumns={@ORM\JoinColumn(name="restaurant_id", referencedColumnName="id", unique=true, onDelete="CASCADE")},
     *      )
     */
    private $restaurants;
